...
const BottomNav = () => {
  ...
  return (
    <>
      {/* Fade gradient overlay above nav. z-30 ispod sheet z-50 da bottom sheets prekriju nav. */}
      ...
      <div className="fixed bottom-2 left-1/2 -translate-x-1/2 z-40 safe-bottom w-[calc(100%-32px)] max-w-[420px]">
        <nav className="liquid-glass-nav rounded-full px-1.5 py-2" aria-label={t("a11y.mainNav")}>
